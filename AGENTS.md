# Graphe Notes — Codex Guide

<!-- Last audited: 2026-04-26 -->

## Adopted engineering standard

The managed Engineering Playbook adoption block is maintained separately from
these project-specific product and delivery rules.
...
This file contains behavioral instructions for Codex. Detailed reference lives in dedicated files — only read them when your task requires it.

| File | Contains | Read when... |
|---|---|---|
| [AGENTS.md](AGENTS.md) (this file) | Working conventions, PR checklist, session startup, branch strategy | Always (loaded automatically) |
...
<!-- TO EXTRACT: This section moves to ARCHITECTURE.md in the documentation restructure. AGENTS.md will keep a 1-2 line summary with a pointer. -->
## Demo Mode Pattern
...
<!-- TO EXTRACT: This section moves to ARCHITECTURE.md (conventions/anti-patterns) and DESIGN.md (visual patterns) in the documentation restructure. AGENTS.md will keep a 1-2 line summary with a pointer. -->
## shadcn/ui Patterns
...
**Token efficiency rule:** AGENTS.md stays under 300 lines of substantive content. All detailed reference content belongs in the dedicated doc files. Do not add API lists, DB schemas, or event catalogs to AGENTS.md.
