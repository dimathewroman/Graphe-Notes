      ...
      <div className="w-full max-w-sm flex flex-col items-center gap-6">
        ...
        <div className="w-full flex flex-col gap-3">
          ...
          <button
            ...
            className="w-full py-3 px-6 rounded-xl bg-black text-white font-medium text-sm hover:bg-gray-900 transition-colors shadow-sm flex items-center justify-center gap-3"
          >
