...
const FONT_SIZE_PRESETS = [8, 10, 12, 14, 16, 18, 20, 24, 28, 32, 36, 48, 64, 72, 96];
...
function FontSizeWidget({ editor }: { editor: ReturnType<typeof useEditor> }) {
    ...
    <ScrollableToolbar className={className} style={style}>
      ...
      <div className="relative shrink-0">
        <button
          ...
          title="Font family"
          className={cn(
            "min-w-[44px] min-h-[44px] md:min-w-0 md:min-h-0 px-2 md:px-1.5 rounded text-muted-foreground hover:bg-panel hover:text-foreground transition-colors shrink-0 flex items-center justify-center text-sm font-medium",
            fontPickerOpen && "bg-panel text-primary"
          )}
        >
          Aa
        </button>
