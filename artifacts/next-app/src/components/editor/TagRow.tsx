      ...
      <AnimatePresence initial={false} mode="popLayout">
        {note?.tags?.map(tag => (
          ...
          >
            ...
            <button onClick={() => onRemoveTag(tag)} className="opacity-0 group-hover:opacity-100 focus-within:opacity-100 coarse:opacity-100 coarse:p-2 coarse:-m-1 hover:text-destructive transition-all ml-0.5">
