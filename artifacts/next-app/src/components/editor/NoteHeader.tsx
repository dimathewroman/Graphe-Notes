...
export const NoteHeader = memo(function NoteHeader({
  ...
  return (
    <header className="min-h-14 pt-safe border-b border-panel-border flex items-center justify-between px-2 md:px-4 shrink-0 bg-editor/80 backdrop-blur-md z-10">
